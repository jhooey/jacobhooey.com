...
<?php if ( have_comments() ) : ?>
	...
	<?php wp_list_comments(array(
  		...
  		'avatar_size' => '72', // Adjust the avatar size
	...
	<ol class="commentlist">
	<?php wp_list_comments(array(
  		'type' => 'pings', // Display the pings here
  		'avatar_size' => '72', // Adjust the avatar size
  		'callback' => 'custom_comments' // Edit the comments markup in functions.php
		)); ?>
		<li id="blank"></li>
...
<label for="author">Name <span><?php if ($req) echo "(required)"; ?></span></label></p>

<p><input type="text" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" size="22" tabindex="2" />
<label for="email">Mail <span>(will not be published) <?php if ($req) echo "(required)"; ?></span></label></p>
